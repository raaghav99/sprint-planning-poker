...
async function handleEmail(params, request, service, env, ctx) {
  let events = [], forwards = [], replies = [], from = params.get("from"), to = params.get("to");
  ...
  ), rejectReason, emailEvent = service.email(
  ...
  rcptTo: ${rcptTo}${renderEmailHeaders(headers)}`)}`
        ...
        let result = { messageId: `${crypto.randomUUID().replaceAll("-", "")}@example.com` };
        return events.push({
          type: "forward",
          timestamp: (/* @__PURE__ */ new Date()).toISOString(),
  ...
  if (params.get("format") !== "json")
    return await emailEvent, rejectReason !== void 0 ? new Response(
  ...
  return await scheduler.wait(0), Response.json(
    {
      outcome,
      rejectReason,
      forwards,
